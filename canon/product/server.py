...
class CanonHandler(BaseHTTPRequestHandler):
    ...
    def do_POST(self) -> None:
        ...
        try:
            ...
            elif parsed.path == "/v1/production/corpus-refresh":
                self.send_json(service.production_corpus_refresh(payload))
        ...
        "routes": [
            ...
            route(
                ...
                ],
                {
                    ...
                    "model_review_model": "openai/gpt-4.1-mini",
            ...
            route(
                "POST",
                "/v1/production/corpus-refresh",
                "Check a local source folder against its last manifest and rebuild only when source files changed.",
                ["input_path", "mode"],
                [
                    "corpus_id",
                    "force",
