...
class ProductReadinessTests(unittest.TestCase):
    def test_readiness_report_passes_for_current_bundle(self):
        ...
        self.assertIn("POST /v1/prehuman-check", report["endpoints"])
        ...
        self.assertIn("POST /v1/intelligence-review/handoff", report["endpoints"])
        ...
        self.assertIn("prehuman_check_endpoint_documented", [check["id"] for check in report["checks"]])
